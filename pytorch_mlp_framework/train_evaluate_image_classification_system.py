...
elif args.block_type == 'BNorm':
    processing_block_type = BNormProcessingBlock
    dim_reduction_block_type = BNormDimensionalityReductionBlock
elif args.block_type == 'ResNet':
